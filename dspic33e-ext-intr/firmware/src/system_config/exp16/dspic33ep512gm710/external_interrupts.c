...
#endif
{
    ...
    while( 1 )
    {
        ...
        _LATA0 = 1;
#ifdef TEST_MODE
// In test mode, while testing connect the pins RB3 and RF8 in order to get external INT1(Expl:16 board mapping)
    if(test_flag ==1)
        break;
