/*******************************************************************************
  ...
  Description:
    ...
    while INT1 through INT2 are configured to generate interrupts on the falling edge.
 *******************************************************************************/
/*******************************************************************************
...
#endif
{
    ...
    while( 1 )
    {
        ...
        _LATA0 = 1;
#ifdef TEST_MODE
// In test mode, while testing connect the pins RB5 and RF8 in order to get external INT1(Expl:16 board mapping)
      if(test_flag ==1)
        break;
