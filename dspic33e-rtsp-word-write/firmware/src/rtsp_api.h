...
extern "C"
{
    ...
    /******************************************************************************
     * Function:        int16_t FlashWordRead(uint16_t nvmRow, uint16_t nvmOffset, uint16_t nvmAdru,
     *                                        uint16_t nvmAdr, int16_t *wordBufptr)
     *
     * PreCondition:    None
     *
     * Input:            nvmRow       - Selects the row in the the Flash page that will be read
     ...
     * Overview:        This function provides the interface to read the flash.
     *****************************************************************************/
    extern int16_t  FlashWordRead( uint16_t nvmRow, uint16_t nvmOffset, uint16_t nvmAdru, uint16_t nvmAdr,
                                   int16_t *wordBufptr );
     ...
     * PreCondition:    None
     *
     * Input:           row- Selects the row of the location to program or erase
                                 in program flash memory
     ...
     * PreCondition:    None
     *
     * Input:           row       - Selects the row in the the Flash page that will be modified
     ...
     * Side Effects:    None
     *
     * Overview:        This function provides the interface to modify data onto the flash..
     *****************************************************************************/
