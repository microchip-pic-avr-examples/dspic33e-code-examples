/*******************************************************************************
  ...
  Summary:
    SPI module intialization and communication

  Description:
    This code example shows using a single SPI module in conjunction with a GPIO to generate an SPI communication 
   that will work with most SPI Slave devices. The code sends from 00h through FFh and then cycles through again.
   A delay was added to permit catching the output on a logic analyzer easier.
...
#warning "XC16 v1.00 detected. It is recommended that a newer version of XC16 be used."
#endif
 ...
 *****************************************************************************/
#ifdef TEST_MODE
unsigned char test_flag, test_data;
int ce_main(void)
#else
int main(void)
#endif
