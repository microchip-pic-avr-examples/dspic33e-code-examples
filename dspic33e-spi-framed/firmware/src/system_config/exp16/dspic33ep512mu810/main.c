 ...
 * Side Effects:    None
 *
 * Overview:        This function provides software Delay
 *****************************************************************************/
void Delay ( void )
{
    int16_t temp;
...
int main ( void )
{
    ...
    _RP104R = 5;            //RP104/RF8 pin configured as SDO1.
    _SDI1R = 18;            //RPI18/RA2 pin configured as SDI1
    RPOR12bits.RP109R = 6;  //RP109/RF13 pin configured as SCK1

    // SS1 pin is set as both Input and output
    // RP101 is configured for Slave Select1
    _SS1R = 101;
    RPOR9bits.RP101R = 7;
