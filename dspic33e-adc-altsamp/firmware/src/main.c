 ...
 *****************************************************************************/
#ifdef TEST_MODE
extern unsigned char test_dma0_buf_flag;
extern unsigned char test_dma1_buf_flag;
...
#ifdef TEST_MODE
    test_dma0_buf_flag=0;
    test_dma1_buf_flag=0;
#endif
    // Configure Oscillator to operate the device at 60Mhz
    // Fosc= Fin*M/(N1*N2), Fcy=Fosc/2
    // Fosc= 8M*60/(2*2)=140Mhz for 8M input clock
    PLLFBD = 58;                                // M=60
