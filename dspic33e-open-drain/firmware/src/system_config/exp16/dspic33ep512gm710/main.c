...
ce442 main file.
 ...
 Company:
  ...
  Description:
    The main.c demonstrates how to configure open drain output port.
*******************************************************************************/
/*******************************************************************************
...
int main ( void )
{
    ...
    TRISDbits.TRISD4 = 0;                       //RD4 as output
    TRISGbits.TRISG2 = 0;                       //RG2 as ouput

    // Open drain configuration
    ODCDbits.ODCD4 = 1;                 //  RD4 has onboard external pull up resistor connected to 3.3v
    ODCGbits.ODCG2 = 1;                 //  connect external pull up resistor(5v)
    LATDbits.LATD4 = 0;
    LATGbits.LATG2 = 0;

    while( 1 )
    {
        if( PORTDbits.RD6 == FALSE )    // is switch S3 pressed
        {
            LATDbits.LATD4 = 1;
            LATGbits.LATG2 = 1;
        }
