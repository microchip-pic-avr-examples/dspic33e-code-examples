...
void Ecan1Init( void )
{
	...
	Ecan1WriteRxAcptFilter(int16_t n, long identifier, unsigned int16_t exide,unsigned int16_t bufPnt,unsigned int16_t maskSel);
...
*/
	...
	Ecan1WriteRxAcptMask(int16_t m, long identifierMask, unsigned int16_t mide, unsigned int16_t exide);
...
*/
    ...
    RPOR9bits.RP97R = 14;           //RPOR7bits.RP97R = 14; set CAN1TX to RP97        (88)
}
