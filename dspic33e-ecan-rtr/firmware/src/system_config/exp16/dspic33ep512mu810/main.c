/*******************************************************************************
  ...
  Summary:
    ...
    ECAN1 and ECAN2 to see if a Remote Transmit Request (RTR) is received.
...
#endif
{
   ...
   Request Remote Reuest Frame Transmission    */
    ...
    {
        if (
            (ecan1msgBuf[1][3] == 0x1111) &&
            (ecan1msgBuf[1][4] == 0x2222) &&
            (ecan1msgBuf[1][5] == 0x3333) &&
            (ecan1msgBuf[1][6] == 0x4444)
...
Ecan2WriteTxMsgBufId(unsigned int16_t buf, long txIdentifier, unsigned int16_t ide, unsigned int16_t remoteTransmit);
Ecan2WriteTxMsgBufData(unsigned int16_t buf, unsigned int16_t dataLength, unsigned int16_t data1, unsigned int16_t data2, unsigned int16_t data3, unsigned int16_t data4);
...
void RxECAN1( mID *message )
{
    ...
    */
    ...
    else
    {
        ...
        message->data[0] = ( uint8_t ) ecan1msgBuf[message->buffer][3];
        message->data[1] = ( uint8_t ) ( (ecan1msgBuf[message->buffer][3] & 0xFF00) >> 8 );
        message->data[2] = ( uint8_t ) ecan1msgBuf[message->buffer][4];
        message->data[3] = ( uint8_t ) ( (ecan1msgBuf[message->buffer][4] & 0xFF00) >> 8 );
        message->data[4] = ( uint8_t ) ecan1msgBuf[message->buffer][5];
        message->data[5] = ( uint8_t ) ( (ecan1msgBuf[message->buffer][5] & 0xFF00) >> 8 );
        message->data[6] = ( uint8_t ) ecan1msgBuf[message->buffer][6];
        message->data[7] = ( uint8_t ) ( (ecan1msgBuf[message->buffer][6] & 0xFF00) >> 8 );
        message->data_length = ( uint8_t ) ( ecan1msgBuf[message->buffer][2] & 0x000F );
    }
}
...
void RxECAN2( mID *message )
{
    ...
    */
    ...
    {
        message->message_type = CAN_MSG_DATA;
        message->data[0] = ( uint8_t ) ecan2msgBuf[message->buffer][3];
        message->data[1] = ( uint8_t ) ( (ecan2msgBuf[message->buffer][3] & 0xFF00) >> 8 );
        message->data[2] = ( uint8_t ) ecan2msgBuf[message->buffer][4];
        message->data[3] = ( uint8_t ) ( (ecan2msgBuf[message->buffer][4] & 0xFF00) >> 8 );
        message->data[4] = ( uint8_t ) ecan2msgBuf[message->buffer][5];
        message->data[5] = ( uint8_t ) ( (ecan2msgBuf[message->buffer][5] & 0xFF00) >> 8 );
        message->data[6] = ( uint8_t ) ecan2msgBuf[message->buffer][6];
        message->data[7] = ( uint8_t ) ( (ecan2msgBuf[message->buffer][6] & 0xFF00) >> 8 );
        message->data_length = ( uint8_t ) ( ecan2msgBuf[message->buffer][2] & 0x000F );
    }
}
