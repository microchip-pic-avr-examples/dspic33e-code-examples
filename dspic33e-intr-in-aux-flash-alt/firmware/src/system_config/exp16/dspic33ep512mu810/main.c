/*******************************************************************************
  ...
  Summary:
    This file demonstrates how to handle interrupts in auxiliary flash. 

  Description:
    The timer 1 is initialized to generate interrupt and interrupt is handled in auxiliary flash.
 *******************************************************************************/
/*******************************************************************************
...
///Auxilliary Interrupt
/******************************************************************************
 * Function:        void __attribute__((__interrupt__, no_auto_psv)) _Aux_Interrupt( void )
 *
 * PreCondition:    None
 *
 * Input:           None
 ...
 * Side Effects:    None
 *
 * Overview:        ISR ROUTINE FOR THE Auxillary INTERRUPT, Toggles the LED
 *****************************************************************************/
void __attribute__ ( (__interrupt__, no_auto_psv) ) _Aux_Interrupt( void )
{
    if( IFS0bits.T1IF )
    {
        // Timer 1 interrupt has occured.
        mLED_1 = led_State;
        led_State = !led_State;
        mLED_2 = led_State;
        TMR1 = 0;
